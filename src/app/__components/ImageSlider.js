...
export default function ImageSlider() {
    ...
    return (
        <div className="bg-img">
            <div className="relative z-[2] max-h-nav w-full flex items-center justify-center gap-6 text-gray-400 font-bold font-mono overflow-hidden">
                ...
                {
                    SlidingImagesUrls?.map((imageUrl, index) => <Image src={imageUrl} alt="" className={`w-[100%] h-fit object-cover md:object-fill shadow-[0_5px_15px_black_inset] bg-white ${activeImageIndex !== index ? "hidden" : "animate-fade"}`} key={index} width={1000} height={8000} />)
                }
