...
export async function POST(req) {
    try {
        ...
        return NextResponse.json({ success:false , message:"your previous request is already pendind and you can not request a new blood donation while the another is pending" });
    }
}